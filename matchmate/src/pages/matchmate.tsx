...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      {/* Nav */}
      <nav className="relative z-20 flex items-center justify-between px-6 py-5 backdrop-blur-lg bg-background/30 border-b border-primary/10">
        <motion.div 
      ...
      {/* Hero Section */}
      <section className="relative z-10 min-h-[calc(100vh-80px)] flex items-center justify-center px-4 sm:px-8">
        <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20">
          {/* Left content */}
          <motion.div
